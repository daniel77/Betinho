...
function submitAcao(perform){
 if(perform != 'insert' && document.forms[0].codFuncionario.value == '' ){
...
<input type='hidden' name="codFuncionario" value="" >
...
<td width="200" ><b>Nome Funcionario</td>

</tr>

<c:forEach var="option" items="${funcionarios}" >
<tr>
<td><input type="radio" name="itens" onclick="document.forms[0].codFuncionario.value='<c:out value="${option.codFuncionario}" />';" ></td>
