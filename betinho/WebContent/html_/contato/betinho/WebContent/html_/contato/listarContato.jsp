...
function submitAcao(perform){
 if(perform != 'insert' && document.forms[0].codContato.value == '' ){
...
<td width="200" ><b>Nome Contato</td>

</tr>

<c:forEach var="option" items="${contatos}" >
<tr>
<td><input type="radio" name="itens" onclick="document.forms[0].codContato.value='<c:out value="${option.codContato}" />';" ></td>
